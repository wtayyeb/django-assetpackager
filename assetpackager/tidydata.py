...
# @version 1.2
GLOBALS['csstidy']['unit_values'] = ['background', 'background-position', 'border', 'border-top', 'border-right', 'border-bottom',
...
# @version 1.0
GLOBALS['csstidy']['color_values'] = ['background-color', 'border-color', 'border-top-color', 'border-right-color',
...
GLOBALS['csstidy']['predefined_templates']['default'].append('<span class="at">') #string before @rule
GLOBALS['csstidy']['predefined_templates']['default'].append('</span> <span class="format">{</span>' + "\n") #bracket after @-rule
GLOBALS['csstidy']['predefined_templates']['default'].append('<span class="selector">') #string before selector
GLOBALS['csstidy']['predefined_templates']['default'].append('</span> <span class="format">{</span>' + "\n") #bracket after selector
GLOBALS['csstidy']['predefined_templates']['default'].append('<span class="property">') #string before property
GLOBALS['csstidy']['predefined_templates']['default'].append('</span><span class="value">') #string after property+before value
GLOBALS['csstidy']['predefined_templates']['default'].append('</span><span class="format">;</span>' + "\n") #string after value
GLOBALS['csstidy']['predefined_templates']['default'].append('<span class="format">}</span>') #closing bracket - selector
GLOBALS['csstidy']['predefined_templates']['default'].append("\n\n") #space between blocks {...}
GLOBALS['csstidy']['predefined_templates']['default'].append("\n" + '<span class="format">}</span>' + "\n\n") #losing bracket @-rule
GLOBALS['csstidy']['predefined_templates']['default'].append('') #indent in @-rule
GLOBALS['csstidy']['predefined_templates']['default'].append('<span class="comment">') # before comment
GLOBALS['csstidy']['predefined_templates']['default'].append('</span>' + "\n") # after comment
GLOBALS['csstidy']['predefined_templates']['default'].append("\n") # after last line @-rule

GLOBALS['csstidy']['predefined_templates']['high_compression'] = []
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('<span class="at">')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('</span> <span class="format">{</span>' + "\n")
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('<span class="selector">')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('</span><span class="format">{</span>')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('<span class="property">')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('</span><span class="value">')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('</span><span class="format">)</span>')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('<span class="format">}</span>')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append("\n")
GLOBALS['csstidy']['predefined_templates']['high_compression'].append("\n" + '<span class="format">}' + "\n" + '</span>')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('')
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('<span class="comment">') # before comment
GLOBALS['csstidy']['predefined_templates']['high_compression'].append('</span>') # after comment
GLOBALS['csstidy']['predefined_templates']['high_compression'].append("\n")

GLOBALS['csstidy']['predefined_templates']['highest_compression'] = []
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('<span class="at">')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('</span><span class="format">{</span>')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('<span class="selector">')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('</span><span class="format">{</span>')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('<span class="property">')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('</span><span class="value">')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('</span><span class="format">)</span>')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('<span class="format">}</span>')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('<span class="format">}</span>')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('')
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('<span class="comment">') # before comment
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('</span>') # after comment
GLOBALS['csstidy']['predefined_templates']['highest_compression'].append('')

GLOBALS['csstidy']['predefined_templates']['low_compression'] = []
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('<span class="at">')
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('</span> <span class="format">{</span>' + "\n")
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('<span class="selector">')
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('</span>' + "\n" + '<span class="format">{</span>' + "\n")
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('    <span class="property">')
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('</span><span class="value">')
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('</span><span class="format">)</span>' + "\n")
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('<span class="format">}</span>')
GLOBALS['csstidy']['predefined_templates']['low_compression'].append("\n\n")
GLOBALS['csstidy']['predefined_templates']['low_compression'].append("\n" + '<span class="format">}</span>' + "\n\n")
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('    ')
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('<span class="comment">') # before comment
GLOBALS['csstidy']['predefined_templates']['low_compression'].append('</span>' + "\n") # after comment
GLOBALS['csstidy']['predefined_templates']['low_compression'].append("\n")